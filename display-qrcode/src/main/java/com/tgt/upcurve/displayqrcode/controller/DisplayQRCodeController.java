package com.tgt.upcurve.displayqrcode.controller;
import com.tgt.upcurve.displayqrcode.service.DisplayQRCodeService;
...
public class DisplayQRCodeController {
    ...
    @Autowired
    DisplayQRCodeService displayQRCodeService;
    ...
    public void generateQRCode(String qrContent, HttpServletResponse response) throws IOException {
        ...
        DisplayQRCodeController qrCodeService;
        byte[] qrCode = displayQRCodeService.getQRCode();
